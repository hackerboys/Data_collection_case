...
import os
import shutil
from deppt import pptxde
from pptx import Presentation

def unzipfiles():
    filepath = r"D:\pro_py\第一PPT\pptzipfile"
    newfilepath = r"D:\pro_py\第一PPT\unzip"
...
def moveppt():
    endfilepath = r"D:\pro_py\第一PPT\endppt"
    filepath = r"D:\pro_py\第一PPT\unzip"
    filename = os.listdir(filepath)
    for f in filename:
        file_folder = os.path.join(filepath, f)  # 分类文件夹
...
def del_ppt():
    global ppt_filepath
    endfilepath = r"D:\pro_py\第一PPT\endppt"
    delfilepath = r"D:\pro_py\第一PPT\def_ppt"
